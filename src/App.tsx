...
function Workspace() {
  ...
  useEffect(() => {
    const onKeyDown = (event: KeyboardEvent) => {
      ...
      if (event.key === 'Escape') setUi({ connectionModalOpen: false, commandPaletteOpen: false, aiSettingsOpen: false });
    };
  ...
  return (
    <div className="app-shell">
      <div className="workspace-titlebar">
        ...
        {bridgeMode === 'demo' ? <div className="demo-banner" data-testid="demo-banner"><span>DEMO</span> Interactive browser workspace · sample data only</div> : <div className="desktop-banner" data-testid="desktop-banner">Redrob Data · Read-only desktop query preview</div>}
